...
export default function App() {
  ...
  return <>
    ...
    <div className="infos-container">
        <InfoBlock image={model} title="Ваши 3D модели" description="Мы получаем ваши 3D модели (сейчас пишу рыбу текст) и автоматически загружаем их на веб-сайт стоковых 3D-моделей, где они будут доступны для покупки." />
